...
const CustomersPageWithPagination = (props) => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8000/api/customers?pagination=true&itemsPerPage=${itemsPerPage}&page=${currentPage}`)
            .then(Response => {
    ...
    return (
        <>
            <h1>Liste des clients with Pagination</h1>
